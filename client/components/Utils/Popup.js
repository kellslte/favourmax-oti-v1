          ...
          <div class="relative w-auto pointer-events-none">
            <div class="border-none shadow-lg relative flex flex-col w-96 md:w-[48rem] pointer-events-auto bg-base bg-clip-padding rounded-md outline-none text-current">
              <div className="flex justify-between items-center py-4 px-6 rounded-t-md md:w-[46rem]">
                <div
                  className="font-medium flex flex-shrink-0 flex-wrap items-center justify-between"
                  id={`modal${id}`}
                >
                  <svg
                    width="32"
                  ...
                  <h1 className="text-white">Super Drive</h1>
                  <div>
                    <button
                      className="btn-close box-content w-4 h-4 p-1 text-white border-none rounded-none opacity-50 focus:shadow-none focus:outline-none focus:opacity-100 hover:text-white hover:opacity-75 hover:no-underline ml-32"
              ...
              <div className="relative px-6 py-2">
                <section>
                  <h5 className="text-white font-monument my-4 text-xs">
                ...
                <section>
                  ...
                  <p className="text-projectColor font-lato mb-2">
                    {project.brief}
                  </p>
